...
export function emailShell(title: string, bodyHtml: string): string {
  return `<!doctype html><html><body style="margin:0;background:#f7f4ec;padding:24px;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#1b1914">
  <div style="max-width:560px;margin:0 auto;background:#ffffff;border:1px solid #e2ddce;border-radius:16px;overflow:hidden">
    <div style="padding:20px 24px;border-bottom:1px solid #eee9dc;display:flex;align-items:center;gap:8px">
      <span style="display:inline-block;width:22px;height:22px;border-radius:999px;background:linear-gradient(135deg,#7fb49f,#205d4a)"></span>
    ...
    <div style="padding:16px 24px;border-top:1px solid #eee9dc;font-size:12px;color:#6f6a5d">
      You're getting this because you turned on notifications in Snowfolio. Turn them off any time from
      the Options page. Informational only, never advice.
    </div>
  </div>
</body></html>`;
}
