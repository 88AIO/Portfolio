...
> **Read the “Verified since publication” section at the end before relying on any figure here.** Three assumptions in this report (Vercel plan, cron firing, data scale) were later checked against the live account and corrected there; where the body and that section disagree, that section wins.
